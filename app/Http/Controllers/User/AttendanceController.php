...
class AttendanceController extends Controller
{
    ...
    {
        $todayAttendance = $this->attendance->findTheDateUserAttendance(Carbon::today()->format('Y-m-d'), Auth::id());
    ...
    public function registerAbsence(AttendanceRequest $request)
    {
        ...
        $todayAttendance = $this->attendance->findTheDateUserAttendance($today, Auth::id());
        $data = $request->all();
        $data['date'] = $today;
    ...
    public function registerCorrection(AttendanceRequest $request)
    {
        ...
        $todayAttendance = $this->attendance->findTheDateUserAttendance($request->date, Auth::id());
        if(isset($todayAttendance)) {
            $todayAttendance->fill($data)->save();
        }else {
            $data['user_id'] = Auth::id();
    ...
    {
        $this->attendance->findTheDateUserAttendance($request->date, Auth::id())
